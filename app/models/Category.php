...
class Category extends Node {
	...
	public static $categories = [
		['name' => 'верх', 'children' => [
			...
			['name' => 'легкое', 'children' => [
				['name' => 'футболка', 'children' => [
					['name' => 'лонглсив']
				]],
				['name' => 'майка'],
				['name' => 'топик']
			...
			['name' => 'тяжелое', 'children' => [
				['name' => 'свитер'],
				['name' => 'куртка', 'children' => [
					['name' => 'анорак'],
					['name' => 'харик'],
					['name' => 'ветровка'],
					['name' => 'джинсовка'],
				]],
				['name' => 'пальто', 'children' => [
					['name' => 'тренч'],
					['name' => 'дафлкот']
				]]
			]]
	...
	public static function seedMe() {
		self::buildTree(static::$categories);
	}
